...
class BasePageLocators():
    ...
    USER_ICON = (By.CSS_SELECTOR, ".icon-user")                     # локатор значка пользователя
...
class LoginPageLocators():
    ...
    REGISTER_EMAIL = (By.NAME, "registration-email")                # локатор email
    REGISTER_PASSWORD = (By.NAME, "registration-password1")         # локатор password
    CONFIRM_PASSWORD = (By.NAME, "registration-password2")          # локатор confirm password
    REGISTER_BUTTON = (By.CSS_SELECTOR, "#register_form > button")  # локатор кнопки регистрации
